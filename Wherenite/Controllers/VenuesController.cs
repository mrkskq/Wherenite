...
namespace Wherenite.Controllers
{
    ...
    public class VenuesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Address,VenueTypeId,PhoneNumber1,PhoneNumber2,PhoneNumber3")] Venue venue)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Address,VenueTypeId,PhoneNumber1,PhoneNumber2,PhoneNumber3")] Venue venue)
        {
            if (ModelState.IsValid)
            {
